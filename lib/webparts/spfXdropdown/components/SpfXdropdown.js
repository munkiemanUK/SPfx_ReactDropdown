...
var SpfXdropdown = /** @class */ (function (_super) {
    ...
    function SpfXdropdown(props) {
        ...
        _this.onComboBoxChange = function (ev, option) {
            _this.setState({ SingleSelect: option.key });
        };
        _this.state = {
            SingleSelect: "",
            MultiSelect: []
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, web.lists.getByTitle("ComboBoxExample").items.add({
                                Title: getGUID(),
    ...
    SpfXdropdown.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("h1", null, "ComboBox Examples"),
            React.createElement(ComboBox, { placeholder: "Single Select ComboBox...", selectedKey: this.state.SingleSelect, label: "Single Select ComboBox", autoComplete: "on", options: this.props.singleValueChoices, onChange: this.onComboBoxChange }),
